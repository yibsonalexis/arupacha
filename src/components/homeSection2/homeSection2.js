...
import { InfoModalHome} from '../infoModalHome/infoModalHome'

export class HomeSection2 extends React.Component {
  state = {
    open: false,
  };
      ...
      <div className="mainContainer">
        <div className="container2">
          ...
          <div className="card">
            ...
            <div className="fab">
              <Fab variant="extended" aria-label="Delete" onClick={this.onOpenModal}>
                Leer más... &nbsp;
